...
public class CreateWxPayLinkRequest extends WxBaseRequest {
    ...
    public CreateWxPayLinkRequest( String body,  String outTradeNo,  Integer totalFee, String spbillCreateIp,  String timeStart, String notifyUrl) {
        this.body = body;
